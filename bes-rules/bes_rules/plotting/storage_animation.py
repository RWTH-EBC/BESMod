...
if __name__ == "__main__":
    ...
    raise FileNotFoundError("You need to define the results folder. After that, comment this line.")
    # result folder in this structure. Can be generated by e.g. the examples when modifiers are
    # added for the heat transfer model of the storage
