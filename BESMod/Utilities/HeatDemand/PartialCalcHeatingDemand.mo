within BESMod.Utilities.HeatDemand;
partial model PartialCalcHeatingDemand
  ...
  parameter Modelica.SIunits.Time TN_heater=1 "Time constant of the heating controller";
...
equation
  connect(heatDemandScenario.useProBus, building.useProBus) annotation (Line(
      points={{-51.0417,48.7417},{6,48.7417},{6,48},{62,48},{62,28},{61.2,28},{
          61.2,24}},
      color={0,127,0},
      thickness=0.5));
...
<p>The heat demand is one of the most important paramters to quantify in order to correctly size the components in a BES. Hence, we add this partial heat demand calculator to enable a heat demand calculation according to EN 12831 for all possible Demand-Subsystems.</p>
<h4>Note:</h4>
<ol>
