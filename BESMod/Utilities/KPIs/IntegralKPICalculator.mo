...
model IntegralKPICalculator "Give integral and value as KPI"
  ...
  Modelica.Blocks.Interfaces.RealInput y if not use_inpCon
    "Value of Real input";
  ...
  Modelica.Blocks.Sources.RealExpression internal_u(y=y) if not use_inpCon
...
equation
  connect(internalU.y, KPI.value) annotation (Line(points={{-19,0},{50,0},{50,
          0.1},{122.1,0.1}},
                        color={0,0,127}), Text(
      string="%second",
      index=1,
  ...
  connect(integrator2.y, KPI.integral) annotation (Line(points={{41,-30},{72,
          -30},{72,0.1},{122.1,0.1}},
                                 color={0,0,127}));
