...
<p>
  This model extends the <a href=
  \"modelica://BuildingSystems.Technologies.ElectricalStorages.BatterySimple\">
...
<ul>
  <li>Available energy (EAva)
  </li>
  <li>Bound energy (EBou)
  </li>
  <li>Total energy (E)
  </li>
  <li>Charged energy (E_charged)
  </li>
  <li>Discharged energy (E_discharged)
  </li>
</ul>
</html>"));
