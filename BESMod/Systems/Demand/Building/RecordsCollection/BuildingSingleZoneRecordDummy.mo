...
record BuildingSingleZoneRecordDummy
  ...
  extends BESMod.Systems.Demand.Building.RecordsCollection.BuildingSingleZoneBaseRecord(
    FacRFloorRem=Modelica.Constants.eps,
    TotalRFloor=Modelica.Constants.inf,
    FacRRoofRem=Modelica.Constants.eps,
    TotalRRoof=Modelica.Constants.inf,
    FacRExtRem=Modelica.Constants.eps,
    TotalRExt=Modelica.Constants.inf,
...
end BuildingSingleZoneRecordDummy;
