...
package SpawnHighOrderOFD
  ...
  equation
    ...
    connect(heatPortRad[1], zoneLiving1.heaPorRad) annotation (Line(points={{-100,
            -54},{-62,-54},{-62,-66},{-20,-66},{-20,59.8},{-40,59.8}}, color={
            191,0,0}));
    connect(heatPortRad[2], zoneHobby2.heaPorRad) annotation (Line(points={{-100,
            -52},{-62,-52},{-62,-66},{78,-66},{78,59.8},{58,59.8}}, color={191,
            0,0}));
    connect(heatPortRad[3], zoneCorridor3.heaPorRad) annotation (Line(points={{
            -100,-50},{-62,-50},{-62,-66},{78,-66},{78,7.8},{58,7.8}}, color={
            191,0,0}));
    connect(heatPortRad[4], zoneWCstorage4.heaPorRad) annotation (Line(points={
            {-100,-48},{-62,-48},{-62,-66},{78,-66},{78,-44.2},{58,-44.2}},
          color={191,0,0}));
    connect(heatPortRad[5], zoneKitchen5.heaPorRad) annotation (Line(points={{-100,
            -46},{-62,-46},{-62,-66},{-20,-66},{-20,-44.2},{-40,-44.2}}, color=
            {191,0,0}));
    connect(heatPortCon[1], zoneLiving1.heaPorAir) annotation (Line(points={{-102,
            60},{-72,60},{-72,64},{-40,64}}, color={191,0,0}));
    connect(heatPortCon[2], zoneHobby2.heaPorAir) annotation (Line(points={{-102,
            62},{-72,62},{-72,86},{34,86},{34,64},{58,64}}, color={191,0,0}));
    connect(heatPortCon[3], zoneCorridor3.heaPorAir) annotation (Line(points={{
            -102,64},{-72,64},{-72,86},{34,86},{34,12},{58,12}}, color={191,0,0}));
    connect(heatPortCon[4], zoneWCstorage4.heaPorAir) annotation (Line(points={
            {-102,66},{-72,66},{-72,86},{34,86},{34,-40},{58,-40}}, color={191,
            0,0}));
    ...
    connect(zoneHobby2.TAir, TZoneMea[2]) annotation (Line(points={{72.7,76.6},
            {90,76.6},{90,75.2},{115,75.2}}, color={0,0,127}));
    connect(zoneCorridor3.TAir, TZoneMea[3]) annotation (Line(points={{72.7,
            24.6},{90,24.6},{90,79},{115,79}}, color={0,0,127}));
    ...
    connect(zoneLiving1.TRad, TZoneRadMea[1]) annotation (Line(points={{-25.3,
            73.8},{-12,73.8},{-12,-88.6},{113,-88.6}}, color={0,0,127}));
    connect(zoneHobby2.TRad, TZoneRadMea[2]) annotation (Line(points={{72.7,
            73.8},{72.7,74},{86,74},{86,-84.8},{113,-84.8}}, color={0,0,127}));
    connect(zoneCorridor3.TRad, TZoneRadMea[3]) annotation (Line(points={{72.7,
            21.8},{72.7,22},{86,22},{86,-81},{113,-81}}, color={0,0,127}));
    connect(zoneWCstorage4.TRad, TZoneRadMea[4]) annotation (Line(points={{72.7,
            -30.2},{86,-30.2},{86,-77.2},{113,-77.2}}, color={0,0,127}));
    connect(zoneKitchen5.TRad, TZoneRadMea[5]) annotation (Line(points={{-25.3,
            -30.2},{-18,-30.2},{-18,-30},{-12,-30},{-12,-88},{86,-88},{86,-73.4},
            {113,-73.4}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneLiving1.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{-60,7},{-60,71.4667},{-55.4,71.4667}}, color={0,0,
            127}));
    connect(qgai_flow_latent.y, zoneHobby2.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{36,7},{36,71.4667},{42.6,71.4667}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneCorridor3.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{36,7},{36,19.4667},{42.6,19.4667}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneWCstorage4.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{36,7},{36,-32.5333},{42.6,-32.5333}}, color={0,0,
            127}));
    connect(qgai_flow_latent.y, zoneKitchen5.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{-60,7},{-60,-32.5333},{-55.4,-32.5333}}, color={0,
            0,127}));
    ...
    connect(freshAir_living1.ports[1], zoneLiving1.ports[1]) annotation (Line(
          points={{-46,41},{-44,41},{-44,50.63},{-41.05,50.63}}, color={0,127,
            255}));
    connect(zoneLiving1.ports[2], duc_living1.port_a) annotation (Line(points={
            {-40.35,50.63},{-40.35,34},{-38,34},{-38,30},{-44,30}}, color={0,
            127,255}));
    ...
    connect(weaBus, freshAir_living1.weaBus) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(portVent_in[1], zoneLiving1.ports[3]) annotation (Line(points={{100,
            40},{-39.65,40},{-39.65,50.63}}, color={0,127,255}));
    connect(portVent_out[1], zoneLiving1.ports[4]) annotation (Line(points={{
            102,-18},{-24,-18},{-24,44},{-38.95,44},{-38.95,50.63}}, color={0,
            127,255}));
    connect(IntGainsRad[1], zoneLiving1.qGai_flow[1]) annotation (Line(points={
            {-105,-31},{-62,-31},{-62,70.5333},{-55.4,70.5333}}, color={0,0,127}));
    connect(IntGainsRad[2], zoneHobby2.qGai_flow[1]) annotation (Line(points={{
            -105,-28},{32,-28},{32,70.5333},{42.6,70.5333}}, color={0,0,127}));
    connect(IntGainsRad[3], zoneCorridor3.qGai_flow[1]) annotation (Line(points
          ={{-105,-25},{32,-25},{32,18.5333},{42.6,18.5333}}, color={0,0,127}));
    connect(IntGainsRad[4], zoneWCstorage4.qGai_flow[1]) annotation (Line(
          points={{-105,-22},{32,-22},{32,-33.4667},{42.6,-33.4667}}, color={0,
            0,127}));
    connect(IntGainsRad[5], zoneKitchen5.qGai_flow[1]) annotation (Line(points=
            {{-105,-19},{-62,-19},{-62,-33.4667},{-55.4,-33.4667}}, color={0,0,
            127}));
    connect(IntGainsConv[1], zoneLiving1.qGai_flow[2]) annotation (Line(points=
            {{-107,13},{-64,13},{-64,71},{-55.4,71}}, color={0,0,127}));
    connect(IntGainsConv[2], zoneHobby2.qGai_flow[2]) annotation (Line(points={
            {-107,16},{30,16},{30,71},{42.6,71}}, color={0,0,127}));
    connect(IntGainsConv[3], zoneCorridor3.qGai_flow[2]) annotation (Line(
          points={{-107,19},{-74,19},{-74,18},{30,18},{30,19},{42.6,19}}, color
          ={0,0,127}));
    connect(IntGainsConv[4], zoneWCstorage4.qGai_flow[2]) annotation (Line(
          points={{-107,22},{-64,22},{-64,14},{28,14},{28,-33},{42.6,-33}},
          color={0,0,127}));
    ...
    connect(freshAir_hobby2.ports[1], zoneHobby2.ports[1]) annotation (Line(
          points={{54,45},{56.95,45},{56.95,50.63}}, color={0,127,255}));
    connect(zoneHobby2.ports[2], duc_hobby2.port_a) annotation (Line(points={{
    ...
    connect(weaBus, freshAir_hobby2.weaBus) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(portVent_in[2], zoneHobby2.ports[3]) annotation (Line(points={{100,
            42},{58.35,42},{58.35,50.63}}, color={0,127,255}));
    connect(portVent_out[2], zoneHobby2.ports[4]) annotation (Line(points={{102,
    ...
    connect(freshAir_corridor3.ports[1], zoneCorridor3.ports[1]) annotation (
        Line(points={{52,-9},{56.95,-9},{56.95,-1.37}}, color={0,127,255}));
    connect(zoneCorridor3.ports[2], duc_corridor3.port_a) annotation (Line(
    ...
    connect(portVent_in[3], zoneCorridor3.ports[3]) annotation (Line(points={{
            100,44},{76,44},{76,-6},{58.35,-6},{58.35,-1.37}}, color={0,127,255}));
    connect(portVent_out[3], zoneCorridor3.ports[4]) annotation (Line(points={{
            102,-14},{59.05,-14},{59.05,-1.37}}, color={0,127,255}));
    ...
    connect(freshAir_wcstorage4.ports[1], zoneWCstorage4.ports[1]) annotation (
        Line(points={{52,-59},{54,-59},{54,-53.37},{56.95,-53.37}}, color={0,
            127,255}));
    connect(zoneWCstorage4.ports[2], duc_wcstorage4.port_a) annotation (Line(
          points={{57.65,-53.37},{57.65,-62},{56,-62},{56,-70}}, color={0,127,
            255}));
    connect(duc_wcstorage4.port_b, pAtm_wcstorage4.ports[1]) annotation (Line(
          points={{44,-70},{42,-70},{42,-73},{20,-73}}, color={0,127,255}));
    connect(portVent_in[4], zoneWCstorage4.ports[3]) annotation (Line(points={{
            100,46},{76,46},{76,-12},{80,-12},{80,-52},{76,-52},{76,-56},{58.35,
            -56},{58.35,-53.37}}, color={0,127,255}));
    connect(portVent_out[4], zoneWCstorage4.ports[4]) annotation (Line(points={
            {102,-12},{80,-12},{80,-54},{76,-54},{76,-58},{59.05,-58},{59.05,-53.37}},
          color={0,127,255}));
    ...
    connect(freshAir_kitchen5.ports[1], zoneKitchen5.ports[1]) annotation (Line(
          points={{-44,-69},{-44,-60},{-41.05,-60},{-41.05,-53.37}}, color={0,
            127,255}));
    connect(zoneKitchen5.ports[2], duc_kitchen5.port_a) annotation (Line(points
          ={{-40.35,-53.37},{-40.35,-68},{-32,-68},{-32,-80},{-40,-80}}, color=
            {0,127,255}));
    connect(duc_kitchen5.port_b, pAtm_kitchen5.ports[1]) annotation (Line(points={
            {-52,-80},{-54,-80},{-54,-83},{-76,-83}}, color={0,127,255}));
    connect(portVent_in[5], zoneKitchen5.ports[3]) annotation (Line(points={{
            100,48},{76,48},{76,-12},{80,-12},{80,-52},{82,-52},{82,-90},{-30,-90},
            {-30,-80},{-32,-80},{-32,-68},{-39.65,-68},{-39.65,-53.37}}, color=
            {0,127,255}));
    connect(portVent_out[5], zoneKitchen5.ports[4]) annotation (Line(points={{
            102,-10},{80,-10},{80,-54},{82,-54},{82,-90},{-30,-90},{-30,-80},{-32,
            -80},{-32,-68},{-38.95,-68},{-38.95,-53.37}}, color={0,127,255}));
    connect(weaBus, freshAir_kitchen5.weaBus) annotation (Line(
        points={{-49,100},{-49,84},{-66,84},{-66,-68.9},{-54,-68.9}},
        color={255,204,51},
        thickness=0.5));
    connect(zoneLiving1.TAir, CalcTZoneOpeMea[1].u1) annotation (Line(points={{
            -25.3,76.6},{-4,76.6},{-4,96},{90,96},{90,17.2},{94.6,17.2}}, color
          ={0,0,127}));
    connect(zoneLiving1.TRad, CalcTZoneOpeMea[1].u2) annotation (Line(points={{
            -25.3,73.8},{-12,73.8},{-12,-88},{86,-88},{86,8},{90,8},{90,8.8},{
            94.6,8.8}}, color={0,0,127}));
    connect(zoneHobby2.TAir, CalcTZoneOpeMea[2].u1) annotation (Line(points={{
            72.7,76.6},{88,76.6},{88,17.2},{94.6,17.2}}, color={0,0,127}));
    connect(zoneHobby2.TRad, CalcTZoneOpeMea[2].u2) annotation (Line(points={{
            72.7,73.8},{72.7,74},{86,74},{86,8.8},{94.6,8.8}}, color={0,0,127}));
    connect(zoneCorridor3.TAir, CalcTZoneOpeMea[3].u1) annotation (Line(points=
            {{72.7,24.6},{72.7,24},{88,24},{88,17.2},{94.6,17.2}}, color={0,0,
            127}));
    connect(zoneCorridor3.TRad, CalcTZoneOpeMea[3].u2) annotation (Line(points=
            {{72.7,21.8},{86,21.8},{86,8.8},{94.6,8.8}}, color={0,0,127}));
    connect(zoneWCstorage4.TAir, CalcTZoneOpeMea[4].u1) annotation (Line(points
          ={{72.7,-27.4},{72.7,-28},{88,-28},{88,17.2},{94.6,17.2}}, color={0,0,
            127}));
    connect(zoneWCstorage4.TRad, CalcTZoneOpeMea[4].u2) annotation (Line(points
          ={{72.7,-30.2},{86,-30.2},{86,8.8},{94.6,8.8}}, color={0,0,127}));
    connect(zoneKitchen5.TAir, CalcTZoneOpeMea[5].u1) annotation (Line(points={
            {-25.3,-27.4},{-4,-27.4},{-4,96},{90,96},{90,86},{88,86},{88,17.2},
            {94.6,17.2}}, color={0,0,127}));
    connect(zoneKitchen5.TRad, CalcTZoneOpeMea[5].u2) annotation (Line(points={
  ...
  equation
    ...
    connect(heatPortRad[1], zoneBedroom6.heaPorRad) annotation (Line(points={{-100,
            -54},{-62,-54},{-62,-66},{-20,-66},{-20,59.8},{-40,59.8}}, color={
            191,0,0}));
    connect(heatPortRad[2], zoneChildren7.heaPorRad) annotation (Line(points={{
            -100,-52},{-62,-52},{-62,-66},{78,-66},{78,59.8},{58,59.8}}, color=
            {191,0,0}));
    connect(heatPortRad[3], zoneCorridor8.heaPorRad) annotation (Line(points={{
            -100,-50},{-62,-50},{-62,-66},{78,-66},{78,7.8},{58,7.8}}, color={
            191,0,0}));
    connect(heatPortRad[4], zoneBath9.heaPorRad) annotation (Line(points={{-100,
            -48},{-62,-48},{-62,-66},{78,-66},{78,-44.2},{58,-44.2}}, color={
            191,0,0}));
    connect(heatPortRad[5], zoneChildren10.heaPorRad) annotation (Line(points={
            {-100,-46},{-62,-46},{-62,-66},{-20,-66},{-20,-44.2},{-40,-44.2}},
          color={191,0,0}));
    connect(heatPortCon[1], zoneBedroom6.heaPorAir) annotation (Line(points={{-102,
            60},{-72,60},{-72,64},{-40,64}}, color={191,0,0}));
    connect(heatPortCon[2], zoneChildren7.heaPorAir) annotation (Line(points={{
            -102,62},{-72,62},{-72,86},{34,86},{34,64},{58,64}}, color={191,0,0}));
    connect(heatPortCon[3], zoneCorridor8.heaPorAir) annotation (Line(points={{
            -102,64},{-72,64},{-72,86},{34,86},{34,12},{58,12}}, color={191,0,0}));
    connect(heatPortCon[4], zoneBath9.heaPorAir) annotation (Line(points={{-102,
            66},{-72,66},{-72,86},{34,86},{34,-40},{58,-40}}, color={191,0,0}));
    connect(heatPortCon[5], zoneChildren10.heaPorAir) annotation (Line(points={
            {-102,68},{-72,68},{-72,-40},{-40,-40}}, color={191,0,0}));
    connect(zoneBedroom6.TAir, TZoneMea[1]) annotation (Line(points={{-25.3,
            76.6},{-4,76.6},{-4,96},{90,96},{90,77.4},{115,77.4}}, color={0,0,
            127}));
    connect(zoneChildren7.TAir, TZoneMea[2]) annotation (Line(points={{72.7,
            76.6},{90,76.6},{90,81.2},{115,81.2}}, color={0,0,127}));
    connect(zoneCorridor8.TAir, TZoneMea[3]) annotation (Line(points={{72.7,
            24.6},{90,24.6},{90,85},{115,85}}, color={0,0,127}));
    connect(zoneBath9.TAir, TZoneMea[4]) annotation (Line(points={{72.7,-27.4},
    ...
    connect(zoneBedroom6.TRad, TZoneRadMea[1]) annotation (Line(points={{-25.3,
            73.8},{-12,73.8},{-12,-88.6},{113,-88.6}}, color={0,0,127}));
    connect(zoneChildren7.TRad, TZoneRadMea[2]) annotation (Line(points={{72.7,
            73.8},{72.7,74},{86,74},{86,-84.8},{113,-84.8}}, color={0,0,127}));
    connect(zoneCorridor8.TRad, TZoneRadMea[3]) annotation (Line(points={{72.7,
            21.8},{72.7,22},{86,22},{86,-81},{113,-81}}, color={0,0,127}));
    connect(zoneBath9.TRad, TZoneRadMea[4]) annotation (Line(points={{72.7,-30.2},
            {86,-30.2},{86,-77.2},{113,-77.2}}, color={0,0,127}));
    connect(zoneChildren10.TRad, TZoneRadMea[5]) annotation (Line(points={{-25.3,
            -30.2},{-18,-30.2},{-18,-30},{-12,-30},{-12,-88},{86,-88},{86,-73.4},
            {113,-73.4}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneBedroom6.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{-60,7},{-60,71.4667},{-55.4,71.4667}}, color={0,0,
            127}));
    connect(qgai_flow_latent.y, zoneChildren7.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{36,7},{36,71.4667},{42.6,71.4667}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneCorridor8.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{36,7},{36,19.4667},{42.6,19.4667}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneBath9.qGai_flow[3]) annotation (Line(points
          ={{-79.5,7},{36,7},{36,-32.5333},{42.6,-32.5333}}, color={0,0,127}));
    connect(qgai_flow_latent.y, zoneChildren10.qGai_flow[3]) annotation (Line(
          points={{-79.5,7},{-60,7},{-60,-32.5333},{-55.4,-32.5333}}, color={0,
            0,127}));
    connect(AirExchangePort, Volume_flow.u) annotation (Line(points={{-103,93},{-102,
            93},{-102,92},{-82.8,92}}, color={0,0,127}));
    ...
    connect(freshAir_bedroom6.ports[1], zoneBedroom6.ports[1]) annotation (Line(
          points={{-46,41},{-44,41},{-44,50.63},{-41.05,50.63}}, color={0,127,
            255}));
    connect(zoneBedroom6.ports[2], duc_bedroom6.port_a) annotation (Line(points
          ={{-40.35,50.63},{-40.35,34},{-38,34},{-38,30},{-44,30}}, color={0,
            127,255}));
    ...
    connect(weaBus, freshAir_bedroom6.weaBus) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(portVent_in[1], zoneBedroom6.ports[3]) annotation (Line(points={{
            100,36},{-39.65,36},{-39.65,50.63}}, color={0,127,255}));
    connect(portVent_out[1], zoneBedroom6.ports[4]) annotation (Line(points={{
            102,-18},{-24,-18},{-24,44},{-38.95,44},{-38.95,50.63}}, color={0,
            127,255}));
    connect(IntGainsRad[1], zoneBedroom6.qGai_flow[1]) annotation (Line(points=
            {{-105,-31},{-62,-31},{-62,70.5333},{-55.4,70.5333}}, color={0,0,
            127}));
    connect(IntGainsRad[2], zoneChildren7.qGai_flow[1]) annotation (Line(points
          ={{-105,-28},{32,-28},{32,70.5333},{42.6,70.5333}}, color={0,0,127}));
    connect(IntGainsRad[3], zoneCorridor8.qGai_flow[1]) annotation (Line(points
          ={{-105,-25},{32,-25},{32,18.5333},{42.6,18.5333}}, color={0,0,127}));
    connect(IntGainsRad[4], zoneBath9.qGai_flow[1]) annotation (Line(points={{
            -105,-22},{32,-22},{32,-33.4667},{42.6,-33.4667}}, color={0,0,127}));
    connect(IntGainsRad[5], zoneChildren10.qGai_flow[1]) annotation (Line(
          points={{-105,-19},{-62,-19},{-62,-33.4667},{-55.4,-33.4667}}, color=
            {0,0,127}));
    connect(IntGainsConv[1], zoneBedroom6.qGai_flow[2]) annotation (Line(points
          ={{-107,13},{-64,13},{-64,71},{-55.4,71}}, color={0,0,127}));
    connect(IntGainsConv[2], zoneChildren7.qGai_flow[2]) annotation (Line(
          points={{-107,16},{30,16},{30,71},{42.6,71}}, color={0,0,127}));
    connect(IntGainsConv[3], zoneCorridor8.qGai_flow[2]) annotation (Line(
          points={{-107,19},{-74,19},{-74,18},{30,18},{30,19},{42.6,19}}, color
          ={0,0,127}));
    connect(IntGainsConv[4], zoneBath9.qGai_flow[2]) annotation (Line(points={{
            -107,22},{-64,22},{-64,14},{28,14},{28,-33},{42.6,-33}}, color={0,0,
            127}));
    connect(IntGainsConv[5], zoneChildren10.qGai_flow[2]) annotation (Line(
    ...
    connect(freshAir_children7.ports[1], zoneChildren7.ports[1]) annotation (
        Line(points={{54,45},{56.95,45},{56.95,50.63}}, color={0,127,255}));
    connect(zoneChildren7.ports[2], duc_children7.port_a) annotation (Line(
    ...
    connect(weaBus, freshAir_children7.weaBus) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(portVent_in[2], zoneChildren7.ports[3]) annotation (Line(points={{
            100,38},{58.35,38},{58.35,50.63}}, color={0,127,255}));
    connect(portVent_out[2], zoneChildren7.ports[4]) annotation (Line(points={{
            102,-16},{80,-16},{80,40},{59.05,40},{59.05,50.63}}, color={0,127,
            255}));
    ...
    connect(calcMassFlow_corridor8.y,freshAir_corridor8. m_flow_in)
      annotation (Line(points={{26.5,-3},{26.5,-5},{42,-5}}, color={0,0,127}));
    connect(freshAir_corridor8.ports[1], zoneCorridor8.ports[1]) annotation (
        Line(points={{52,-9},{56.95,-9},{56.95,-1.37}}, color={0,127,255}));
    connect(zoneCorridor8.ports[2], duc_corridor8.port_a) annotation (Line(
          points={{57.65,-1.37},{56,-1.37},{56,-20}}, color={0,127,255}));
    connect(duc_corridor8.port_b,pAtm_corridor8. ports[1])
      annotation (Line(points={{44,-20},{44,-17},{26,-17}}, color={0,127,255}));
    connect(portVent_in[3], zoneCorridor8.ports[3]) annotation (Line(points={{
            100,40},{76,40},{76,-6},{58.35,-6},{58.35,-1.37}}, color={0,127,255}));
    connect(portVent_out[3], zoneCorridor8.ports[4]) annotation (Line(points={{
            102,-14},{59.05,-14},{59.05,-1.37}}, color={0,127,255}));
    ...
    connect(freshAir_bath9.ports[1], zoneBath9.ports[1]) annotation (Line(
          points={{52,-59},{54,-59},{54,-53.37},{56.95,-53.37}}, color={0,127,
            255}));
    connect(zoneBath9.ports[2], duc_bath9.port_a) annotation (Line(points={{
            57.65,-53.37},{57.65,-62},{56,-62},{56,-70}}, color={0,127,255}));
    connect(duc_bath9.port_b, pAtm_bath9.ports[1]) annotation (Line(points={{44,-70},
            {42,-70},{42,-73},{20,-73}}, color={0,127,255}));
    connect(portVent_in[4], zoneBath9.ports[3]) annotation (Line(points={{100,
            42},{76,42},{76,-12},{80,-12},{80,-52},{76,-52},{76,-56},{58.35,-56},
            {58.35,-53.37}}, color={0,127,255}));
    connect(portVent_out[4], zoneBath9.ports[4]) annotation (Line(points={{102,
    ...
    connect(calcMassFlow_children10.y, freshAir_children10.m_flow_in) annotation (
       Line(points={{-69.5,-63},{-69.5,-65},{-54,-65}}, color={0,0,127}));
    connect(freshAir_children10.ports[1], zoneChildren10.ports[1]) annotation (
        Line(points={{-44,-69},{-44,-60},{-41.05,-60},{-41.05,-53.37}}, color={
            0,127,255}));
    connect(zoneChildren10.ports[2], duc_children10.port_a) annotation (Line(
    ...
    connect(portVent_in[5], zoneChildren10.ports[3]) annotation (Line(points={{
            100,44},{76,44},{76,-12},{80,-12},{80,-52},{82,-52},{82,-90},{-30,-90},
            {-30,-80},{-32,-80},{-32,-68},{-39.65,-68},{-39.65,-53.37}}, color=
            {0,127,255}));
    connect(portVent_out[5], zoneChildren10.ports[4]) annotation (Line(points={
            {102,-10},{80,-10},{80,-54},{82,-54},{82,-90},{-30,-90},{-30,-80},{
            -32,-80},{-32,-68},{-38.95,-68},{-38.95,-53.37}}, color={0,127,255}));
    connect(weaBus, freshAir_children10.weaBus) annotation (Line(
        points={{-49,100},{-49,84},{-66,84},{-66,-68.9},{-54,-68.9}},
        color={255,204,51},
        thickness=0.5));
    connect(zoneBedroom6.TAir, CalcTZoneOpeMea[1].u1) annotation (Line(points={
            {-25.3,76.6},{-4,76.6},{-4,96},{90,96},{90,17.2},{94.6,17.2}},
          color={0,0,127}));
    connect(zoneBedroom6.TRad, CalcTZoneOpeMea[1].u2) annotation (Line(points={
            {-25.3,73.8},{-12,73.8},{-12,-88},{86,-88},{86,8},{90,8},{90,8.8},{
            94.6,8.8}}, color={0,0,127}));
    connect(zoneChildren7.TAir, CalcTZoneOpeMea[2].u1) annotation (Line(points=
            {{72.7,76.6},{88,76.6},{88,17.2},{94.6,17.2}}, color={0,0,127}));
    connect(zoneChildren7.TRad, CalcTZoneOpeMea[2].u2) annotation (Line(points=
            {{72.7,73.8},{72.7,74},{86,74},{86,8.8},{94.6,8.8}}, color={0,0,127}));
    connect(zoneCorridor8.TAir, CalcTZoneOpeMea[3].u1) annotation (Line(points=
            {{72.7,24.6},{72.7,24},{88,24},{88,17.2},{94.6,17.2}}, color={0,0,
            127}));
    connect(zoneCorridor8.TRad, CalcTZoneOpeMea[3].u2) annotation (Line(points=
            {{72.7,21.8},{86,21.8},{86,8.8},{94.6,8.8}}, color={0,0,127}));
    connect(zoneBath9.TAir, CalcTZoneOpeMea[4].u1) annotation (Line(points={{
            72.7,-27.4},{72.7,-28},{88,-28},{88,17.2},{94.6,17.2}}, color={0,0,
            127}));
    connect(zoneBath9.TRad, CalcTZoneOpeMea[4].u2) annotation (Line(points={{
            72.7,-30.2},{86,-30.2},{86,8.8},{94.6,8.8}}, color={0,0,127}));
  ...
  equation
    ...
    connect(freshAir_attic.ports[1], zoneAttic.ports[1]) annotation (Line(
          points={{-30,-18},{7.3,-18},{7.3,-5.37}}, color={0,127,255}));
    connect(zoneAttic.ports[2], duc_attic.port_a) annotation (Line(points={{8.7,
            -5.37},{6,-5.37},{6,-41},{-10,-41}}, color={0,127,255}));
    ...
    connect(weaBus, freshAir_attic.weaBus) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(qgain.y, zoneAttic.qGai_flow) annotation (Line(points={{-21.3,33},{
            -12,33},{-12,15},{-7.4,15}}, color={0,0,127}));
