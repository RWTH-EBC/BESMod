...
model ConvertRoomsInputsDelayLossPT1nR
  ...
  parameter Modelica.Units.SI.Time timeConstUse[nRooms] = fill(300, nRooms);
  ...
  Modelica.Blocks.Continuous.FirstOrder useRate[nRooms](k=useLossRatio, T=
        timeConstUse)
...
equation
  ...
  connect(delayedGains.y, useRate.u) annotation (Line(points={{-17,-17.3},{-17,18},
          {40.4,18}}, color={0,0,127}));
  connect(useRate.y, sum1.u)
    annotation (Line(points={{58.8,18},{87,18},{87,3.4}}, color={0,0,127}));
  connect(sum1.y, add2.u1) annotation (Line(points={{87,-12.7},{86,-12.7},{86,-30},
          {92,-30},{92,-54},{80.8,-54},{80.8,-60.4}}, color={0,0,127}));
end ConvertRoomsInputsDelayLossPT1nR;
