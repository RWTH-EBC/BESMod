...
protected
 ...
 if AFloor > 0 "Coefficient of convective heat transfer for floor"
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor resExtWallFloor(
      final G=min(ATotExt*ratioExtWallAreaBottomFloor, AFloor)*hRad) if ATotExt > 0 and AFloor > 0 and ratioExtWallAreaBottomFloor > 0
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor resIntWallFloor(
      final G=min(AFloor, AInt*ratioIntWallAreaBottomFloor)*hRad) if AInt > 0 and AFloor > 0 and ratioIntWallAreaBottomFloor > 0
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor resFloorWin(
    final G=min(ATotWin*ratioWinAreaBottomFloor, AFloor)*hRad) if ATotWin > 0 and AFloor > 0 and ratioWinAreaBottomFloor > 0
