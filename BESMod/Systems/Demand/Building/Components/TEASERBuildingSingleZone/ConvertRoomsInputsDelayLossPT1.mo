...
model ConvertRoomsInputsDelayLossPT1
...
equation
  ...
  connect(sum1.y, useRate.u)
    annotation (Line(points={{-17,2.7},{-17,18},{40.4,18}}, color={0,0,127}));
  connect(useRate.y, add2.u1) annotation (Line(points={{58.8,18},{92,18},{92,-54},
          {80.8,-54},{80.8,-60.4}}, color={0,0,127}));
end ConvertRoomsInputsDelayLossPT1;
