...
protected
  ...
  Modelica.Blocks.Math.Gain eRadSol[nOrientations](
    each final k(each unit="m2") = (1 - ratioWinConRad),
  ...
  Modelica.Blocks.Math.Gain eConvSol[nOrientations](
    each final k(each unit="m2") = ratioWinConRad,
    u(each final unit="W/m2"),
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor resExtWallWin(
      final G=min(ATotExt, ATotWin*ratioWinAreaExtWall)*hRad) if ATotExt > 0 and ATotWin > 0 and ratioWinAreaExtWall > 0
