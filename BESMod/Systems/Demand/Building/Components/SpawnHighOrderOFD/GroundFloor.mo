...
equation
  ...
  connect(heatPortRad[2], zoneHobby2.heaPorRad) annotation (Line(points={{-100,
          -52},{-62,-52},{-62,-66},{78,-66},{78,59.8},{58,59.8}}, color={191,0,
          0}));
  ...
  connect(heatPortRad[4], zoneWCstorage4.heaPorRad) annotation (Line(points={{-100,
          -48},{-62,-48},{-62,-66},{78,-66},{78,-44.2},{58,-44.2}}, color={191,
          0,0}));
  ...
  connect(zoneKitchen5.TRad, TZoneRadMea[5]) annotation (Line(points={{-25.3,-30.2},
        ...
        color={0,0,127}));
  connect(qgai_flow_latent.y, zoneLiving1.qGai_flow[3]) annotation (Line(points
        ={{-79.5,7},{-60,7},{-60,71.4667},{-55.4,71.4667}}, color={0,0,127}));
  connect(qgai_flow_latent.y, zoneHobby2.qGai_flow[3]) annotation (Line(points=
          {{-79.5,7},{36,7},{36,71.4667},{42.6,71.4667}}, color={0,0,127}));
  ...
  connect(qgai_flow_latent.y, zoneKitchen5.qGai_flow[3]) annotation (Line(
        points={{-79.5,7},{-60,7},{-60,-32.5333},{-55.4,-32.5333}}, color={0,0,
          127}));
  ...
  connect(zoneLiving1.ports[2], duc_living1.port_a) annotation (Line(points={{-40.35,
  ...
  connect(portVent_out[1], zoneLiving1.ports[4]) annotation (Line(points={{102,
  ...
  connect(IntGainsRad[4], zoneWCstorage4.qGai_flow[1]) annotation (Line(points=
          {{-105,-22},{32,-22},{32,-33.4667},{42.6,-33.4667}}, color={0,0,127}));
  connect(IntGainsRad[5], zoneKitchen5.qGai_flow[1]) annotation (Line(points={{
          -105,-19},{-62,-19},{-62,-33.4667},{-55.4,-33.4667}}, color={0,0,127}));
  ...
  connect(IntGainsConv[3], zoneCorridor3.qGai_flow[2]) annotation (Line(points=
          {{-107,19},{-74,19},{-74,18},{30,18},{30,19},{42.6,19}}, color={0,0,
          127}));
  ...
  connect(freshAir_corridor3.ports[1], zoneCorridor3.ports[1]) annotation (Line(
        points={{52,-9},{56.95,-9},{56.95,-1.37}}, color={0,127,255}));
  connect(zoneCorridor3.ports[2], duc_corridor3.port_a) annotation (Line(points
  ...
  connect(freshAir_wcstorage4.ports[1], zoneWCstorage4.ports[1]) annotation (
      Line(points={{52,-59},{54,-59},{54,-53.37},{56.95,-53.37}}, color={0,127,
          255}));
  ...
  connect(portVent_in[4], zoneWCstorage4.ports[3]) annotation (Line(points={{
          100,46},{76,46},{76,-12},{80,-12},{80,-52},{76,-52},{76,-56},{58.35,-56},
  ...
  connect(portVent_in[5], zoneKitchen5.ports[3]) annotation (Line(points={{100,
          48},{76,48},{76,-12},{80,-12},{80,-52},{82,-52},{82,-90},{-30,-90},{-30,
          -80},{-32,-80},{-32,-68},{-39.65,-68},{-39.65,-53.37}}, color={0,127,
          255}));
  ...
  connect(zoneLiving1.TAir, CalcTZoneOpeMea[1].u1) annotation (Line(points={{-25.3,
          76.6},{-4,76.6},{-4,96},{90,96},{90,17.2},{94.6,17.2}}, color={0,0,
          127}));
  ...
  connect(zoneKitchen5.TAir, CalcTZoneOpeMea[5].u1) annotation (Line(points={{-25.3,
          -27.4},{-4,-27.4},{-4,96},{90,96},{90,86},{88,86},{88,17.2},{94.6,
          17.2}}, color={0,0,127}));
  connect(zoneKitchen5.TRad, CalcTZoneOpeMea[5].u2) annotation (Line(points={{-25.3,
          -30.2},{-12,-30.2},{-12,-88},{86,-88},{86,8.8},{94.6,8.8}}, color={0,
          0,127}));
