...
equation
  ...
  connect(zoneBedroom6.ports[2], duc_bedroom6.port_a) annotation (Line(points={
          {-40.35,50.63},{-40.35,34},{-38,34},{-38,30},{-44,30}}, color={0,127,
          255}));
  ...
  connect(weaBus, freshAir_bedroom6.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(portVent_in[1], zoneBedroom6.ports[3]) annotation (Line(points={{100,
  ...
  connect(IntGainsRad[5], zoneChildren10.qGai_flow[1]) annotation (Line(points=
  ...
  connect(freshAir_children7.ports[1], zoneChildren7.ports[1]) annotation (Line(
        points={{54,45},{56.95,45},{56.95,50.63}}, color={0,127,255}));
  connect(zoneChildren7.ports[2], duc_children7.port_a) annotation (Line(points
  ...
  connect(portVent_out[2], zoneChildren7.ports[4]) annotation (Line(points={{
          102,-16},{80,-16},{80,40},{59.05,40},{59.05,50.63}}, color={0,127,255}));
  ...
  connect(freshAir_corridor8.ports[1], zoneCorridor8.ports[1]) annotation (Line(
        points={{52,-9},{56.95,-9},{56.95,-1.37}}, color={0,127,255}));
  connect(zoneCorridor8.ports[2], duc_corridor8.port_a) annotation (Line(points
  ...
  connect(freshAir_bath9.ports[1], zoneBath9.ports[1]) annotation (Line(points=
          {{52,-59},{54,-59},{54,-53.37},{56.95,-53.37}}, color={0,127,255}));
  connect(zoneBath9.ports[2], duc_bath9.port_a) annotation (Line(points={{57.65,
  ...
  connect(portVent_in[4], zoneBath9.ports[3]) annotation (Line(points={{100,42},
          {76,42},{76,-12},{80,-12},{80,-52},{76,-52},{76,-56},{58.35,-56},{
  ...
  connect(freshAir_children10.ports[1], zoneChildren10.ports[1]) annotation (
      Line(points={{-44,-69},{-44,-60},{-41.05,-60},{-41.05,-53.37}}, color={0,
          127,255}));
  ...
  connect(portVent_in[5], zoneChildren10.ports[3]) annotation (Line(points={{
          ...
          {-30,-80},{-32,-80},{-32,-68},{-39.65,-68},{-39.65,-53.37}}, color={0,
          127,255}));
