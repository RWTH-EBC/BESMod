...
model CalcHeaDemHOM_WeatherData
  ...
  extends PartialCalcHeatingDemand(
    ...
    redeclare Examples.UseCaseHighOrderModel.HOMSystem systemParameters(
      ...
      filNamWea=Modelica.Utilities.Files.loadResource(
          "D:/Programme/Bim2Sim/bim2sim/bim2sim/assets/weatherfiles/DEU_NW_Aachen.105010_TMYx.mos")),
    redeclare AixLibHighOrder building(
      ...
      HOMBuiEnv(TIR=2, wholeHouseBuildingEnvelope(
          ...
          attic_2Ro_5Rooms(roof_width1=6, roof_width2=6)))),
