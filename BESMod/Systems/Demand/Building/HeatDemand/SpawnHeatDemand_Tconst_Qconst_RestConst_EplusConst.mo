...
model SpawnHeatDemand_Tconst_Qconst_RestConst_EplusConst
  ...
  extends PartialCalcHeatingDemand(
    ...
    redeclare BESMod.Systems.Demand.Building.SpawnHOM building(use_openModelica=
      ...
      epw_name=Modelica.Utilities.Files.loadResource(
          "D:/Programme/AixWeather/results/Aachen_Tconst_Qconst_RestConst_EplusConst.epw"),
...
end SpawnHeatDemand_Tconst_Qconst_RestConst_EplusConst;
