...
model SpawnHighOrder "Spawn model of the AixLib High Order Model"
  ...
  Modelica.Blocks.Math.Add TZoneOpeMeaKelvin[nZones + nZonesNonHeated](each k1=
        0.5, each k2=0.5) "Operative room temperature"
  ...
  Modelica.Blocks.Math.Gain InternalGainsConvRatio[nZones](each k=0.6)
    annotation (Placement(transformation(extent={{80,-58},{68,-46}})));
...
equation
  ...
  connect(useProBus.intGains, InternalGainsConvRatio.u) annotation (Line(
      points={{51,101},{84,101},{84,-52},{81.2,-52}},
      color={0,0,127}));
  connect(useProBus.intGains, InternalGainsRadRatio.u) annotation (Line(
      points={{51,101},{86,101},{86,-70},{81.2,-70}},
      color={0,0,127}));
  connect(InternalGainsRadRatio[1:5].y, groundFloor.IntGainsRad) annotation (
      Line(points={{67.4,-70},{52,-70},{52,-86},{26,-86},{26,-92},{-44,-92},{-44,
          -70},{-25.4,-70}},
        color={0,0,127}));
  connect(InternalGainsRadRatio[6:10].y, upperFloor.IntGainsRad) annotation (
      Line(points={{67.4,-70},{52,-70},{52,-86},{26,-86},{26,-92},{-44,-92},{-44,
          -2},{-25.35,-2}},
        color={0,0,127}));
  connect(InternalGainsConvRatio[1:5].y, groundFloor.IntGainsConv) annotation (
      Line(points={{67.4,-52},{50,-52},{50,-82},{24,-82},{24,-88},{-40,-88},{-40,
          -59.44},{-25.96,-59.44}},
        color={0,0,127}));
  connect(InternalGainsConvRatio[6:10].y, upperFloor.IntGainsConv) annotation (
      Line(points={{67.4,-52},{50,-52},{50,-82},{24,-82},{24,-88},{-40,-88},{-40,
          8.56},{-25.89,8.56}},
        color={0,0,127}));
