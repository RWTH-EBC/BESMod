...
record DHWDesignParameters
  ...
  parameter Modelica.Units.SI.Volume VDHWDay "Daily volume of DHW tapping" annotation (Dialog(group="DHW Demand"));
  parameter Modelica.Units.SI.HeatFlowRate QDHW_flow_nominal "Nominal heat flow rate of DHW system" annotation (Dialog(group="DHW Demand"));
