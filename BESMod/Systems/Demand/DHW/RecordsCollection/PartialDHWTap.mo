...
record PartialDHWTap
  ...
  parameter Modelica.Units.SI.Energy QCrit(displayUnit="kWh") "Energy demand during critical period according to EN 15450 assuming 60 °C set temperature" annotation (Dialog(group="Design - Bottom Up: Parameters are defined by the subsystem"));
