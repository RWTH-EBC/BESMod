...
model UFHTransferSystemSpacingFix
  ...
  Hydraulics.Systems.Demand.Hydraulical.Components.UFH.PanelHeatingPossibleAFloorFix
    ...
    each panelHeatingSegmentPossibleAFloorFix(each fixedInitial=energyDynamics
           == Modelica.Fluid.Types.Dynamics.FixedInitial)) "Underfloor heating"
    annotation (Placement(transformation(
        extent={{-20,-10},{20,10}},
        rotation=270,
        origin={10,0})));
  ...
  Utilities.KPIs.EnergyKPICalculator integralKPICalculator[nParallelDem](each final
...
end UFHTransferSystemSpacingFix;
