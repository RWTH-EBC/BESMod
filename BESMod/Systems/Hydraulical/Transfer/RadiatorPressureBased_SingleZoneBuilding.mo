...
model RadiatorPressureBased_SingleZoneBuilding
  "Pressure Based transfer system for single zone building models"
  ...
  BESMod.Systems.Hydraulical.Components.RadiatorEN442_2_SingleZoneBuilding rad[nParallelDem](
...
end RadiatorPressureBased_SingleZoneBuilding;
