...
record RadiatorTransferData
  ...
  parameter Real fraRad=0.35 "Fraction radiant heat transfer" annotation(Evaluate=false);
  parameter Real n=1.24 "Exponent for heat transfer" annotation(Evaluate=false);
