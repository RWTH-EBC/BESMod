...
model TestOpenModelica
  ...
  BESMod.Systems.Hydraulical.Transfer.RadiatorPressureBasedOpenModelica
    transfer(
    redeclare
      Systems.Hydraulical.Transfer.RecordsCollection.RadiatorTransferData
      parRad,
    dTTra_nominal={15},
    dTTra_design={15},
    dTTraOld_design={15},
    ...
    QSup_flow_nominal={10632.4149429430780},
    QSupOld_flow_design={10632.4149429430780},
    mSup_flow_nominal={0.16941387735728294},
    mSup_flow_design={0.16941387735728294},
    mSupOld_flow_design={0.16941387735728294},
    dpSup_nominal(each displayUnit="Pa") = {1000},
    dpSup_design(each displayUnit="Pa") = {1000},
    dpSupOld_design(each displayUnit="Pa") = {1000},
    Q_flow_design={10632.4149429430780},
    m_flow_design={0.16941387735728294},
    use_oldRad_design={true},
    TSup_nominal={328.15},
    TSupOld_design={328.15},
    TTra_design={328.15},
    dpOld_design(each displayUnit="Pa") = {1000},
    dp_nominal={1000},
    dpPipSca_design={1000},
    dpFixedTotal_nominal={1100},
    dpPipSupSca_design={1000},
    dpPipSupSca_nominal={1100},
    nParallelDem=1,
...
equation
  ...
  connect(bou1.ports[1], transfer.portTra_out) annotation(
    Line(points={{-60,-50},{-46,-50},{-46,-6},{-32,-6},{-32,-5.7}},          color = {0, 127, 255}, thickness = 0.5));
  connect(boundary.ports[1], transfer.portTra_in) annotation(
    Line(points={{-64,40},{-32,40},{-32,23}},        color = {0, 127, 255}, thickness = 0.5));
  annotation(
