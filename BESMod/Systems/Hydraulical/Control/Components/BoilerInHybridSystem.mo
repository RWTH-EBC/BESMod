...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-100,-100},{100,100}})), Icon(
        coordinateSystem(extent={{-100,-100},{80,100}})), Documentation(info="<html>
<p>
Model for controlling the boiler operation in a hybrid system with primary and secondary generator. 
The model decides when to operate the boiler based on outdoor temperature conditions and primary generator status.
</p>

<h4>Important Parameters</h4>
<ul>
<li><code>TBiv</code>: Bivalence temperature - Temperature threshold below which secondary heating is allowed</li>
<li><code>TCutOff</code>: Cut-off temperature - Temperature threshold below which boiler operation is always enabled</li>
</ul>
...
<ul>
<li>Outdoor temperature is below cut-off temperature (TCutOff)</li>
<li>All of the following conditions are true:
  <ul>
  <li>Outdoor temperature is below bivalence temperature (TBiv)</li>
  <li>Secondary generator use is requested</li>
  <li>Either:
    <ul>
    <li>Primary generator is blocked due to safety issues, or</li>
    <li>Primary generator is running at maximum capacity (>85-90% load)</li>
    </ul>
  </li>
  </ul>
</li>
