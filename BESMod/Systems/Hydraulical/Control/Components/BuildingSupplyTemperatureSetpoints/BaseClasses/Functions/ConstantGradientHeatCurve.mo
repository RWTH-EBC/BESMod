...
<p>A simple heating curve with a constant gradient based on nominal parameters. 
The gradient is calculated using nominal supply temperature <code>TSup_nominal</code>, nominal outdoor temperature 
<code>TOda_nominal</code>, nominal return temperature <code>TRet_nominal and heating threshold temperature <code>THeaThr</code>.
</p>

<h4>Mathematical Description</h4>
<p>The heating curve is defined by the slope <code>graTSupAtTOda_nominal</code> which remains 
constant over the whole operating range</p>
</html>"));
