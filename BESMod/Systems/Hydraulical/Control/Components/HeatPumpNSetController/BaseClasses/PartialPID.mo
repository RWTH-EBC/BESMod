...
model PartialPID "Partial PID controller for inverter controlled devices"
  extends PartialControler(                   setOn(start=true));
...
equation
  ...
  connect(usOn, and1.u2) annotation (Line(points={{-60,-120},{-60,-62},{-54,-62}},
        color={255,0,255}));
end PartialPID;
