...
model MonoenergeticHeatPumpSystem
  ...
  extends BaseClasses.PartialHeatPumpSystemController(final meaValSecGen=BESMod.Systems.Hydraulical.Control.Components.MeasuredValue.GenerationSupplyTemperature);
