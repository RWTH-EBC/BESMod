...
model MonoenergeticHeatPumpSystemSingleZoneBui
  "Monoenergetic HPS with on/off electric heater"
  extends BaseClasses.PartialHeatPumpSystemControllerSingleZoneBui(
...
equation
  ...
  connect(constTraPumOn.y, sigBusDistr.uPumTra) annotation (Line(points={{-39,-30},
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
end MonoenergeticHeatPumpSystemSingleZoneBui;
