...
partial model PartialTwoPoint_HPS_Controller_BivalentBoiler
  ...
  Modelica.Blocks.MathBoolean.Or heatDemand_AuxiliarHeater(nu=3)
    "heat demand based on buffer temperatures" annotation (Placement(
        transformation(
        extent={{-5,-5},{5,5}},
        rotation=0,
        origin={21,23})));
...
equation
  ...
  connect(HP_nSet_Controller.IsOn, sigBusGen.heaPumIsOn) annotation (Line(
        points={{88,61.2},{88,48},{156,48},{156,-54},{-152,-54},{-152,-99}},
                                                           color={255,0,255}),
      Text(
      string="%second",
      index=1,
  ...
  connect(booleanToReal1.y, sigBusGen.uPump) annotation (Line(points={{-170,-65},
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(HP_or_HR_active.u1, heatDemand_AuxiliarHeater.y) annotation (Line(
        points={{-170,-12},{-170,-6},{-90,-6},{-90,-2},{32,-2},{32,23},{26.75,
          23}}, color={255,0,255}));
