...
model BivalentPartParallel
  ...
  extends BaseClasses.PartialHeatPumpSystemController(
    redeclare
      ...
      yMin=bivalentControlData.nMin,
      timeInt=bivalentControlData.T_I),
    redeclare
...
equation
  connect(priGenPIDCtrl.TMea, sigBusGen.THeaPumOut) annotation (Line(points={{110,
          80.4},{110,-56},{-152,-56},{-152,-99}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,-6},{-3,-6}},
