...
model TwoStoDetailedIndirectLoading_forUFH
  "Two detailed storages, indirect loading of space heating for UFH"
  extends BaseClasses.PartialDistributionTwoStorageParallelDetailed_HCPipeForUFH(final
...
end TwoStoDetailedIndirectLoading_forUFH;
