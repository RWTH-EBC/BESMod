...
partial model PartialTwoStorageSerial "Partial model to later extent"
  extends BaseClasses.PartialThreeWayValve(
    ...
    pumGen(dp_nominal=dpSup_design[1] + (parThrWayVal.dpValve_nominal +
          parThrWayVal.dpMax_nominal) + dpDem_design[1] + dpBufToDem_design));
...
equation
  ...
  connect(heaRodparStoDHW.PEleHea, multiSum.u[1]) annotation (Line(points={{-69,-57},
          {-66,-57},{-66,-113.1},{-58,-113.1}},          color={0,0,127}));
  connect(heaRodBuf.PEleHea, multiSum.u[2]) annotation (Line(points={{-69,13},{
          -64,13},{-64,-108},{-58,-108},{-58,-111}}, color={0,0,127}));
  ...
  connect(multiSum.u[3], pumGen.P) annotation (Line(points={{-58,-108.9},{-70,
          -108.9},{-70,-110},{-126,-110},{-126,102},{-74,102},{-74,109}},
        color={0,0,127}));
