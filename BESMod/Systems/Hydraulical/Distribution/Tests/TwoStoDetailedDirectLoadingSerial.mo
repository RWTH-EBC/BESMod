...
model TwoStoDetailedDirectLoadingSerial
  extends BaseClasses.PartialTest(
                      redeclare
      BESMod.Systems.Hydraulical.Distribution.TwoStoDetailedDirectLoadingSerial
      distribution(
      redeclare
...
annotation (experiment(StopTime=3600, Tolerance=1e-06, Interval=100),
     __Dymola_Commands(file="modelica://BESMod/Resources/Scripts/Dymola/Systems/Hydraulical/Distribution/Tests/TwoStoDetailedDirectLoadingSerial.mos"
          "Simulate and plot"),
