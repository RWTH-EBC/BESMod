...
equation
  ...
  connect(KPIWHRel.KPI, outBusGen.PEleHR) annotation (Line(points={{-117.8,-38},
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(KPIHeaPum.KPI, outBusGen.heaPum) annotation (Line(points={{-117.8,-10},
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(KPIHeaRod.KPI, outBusGen.heaRod) annotation (Line(points={{-77.8,-110},
          {0,-110},{0,-100}}, color={135,135,135}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(KPIHeaRod.uRea, sigBusGen.uHeaRod) annotation (Line(points={{-102.2,-110},
          {-128,-110},{-128,-112},{-150,-112},{-150,98},{2,98}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(booExpHeaPumIsOn.y,KPIHeaPum. u)
...
end HeatPumpAndHeatingRod_numSwiEachDay;
