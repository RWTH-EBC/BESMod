...
model HeatPumpAndGasBoilerSerial "serial arrangement of heatpump and boiler"
  extends
    ...
    resGenApp(final dp_nominal=parHeaPum.dpCon_nominal + dpBoi_nominal + resGen.dp_nominal));
...
equation
  ...
  connect(resGen.port_a, heatPump.port_a1) annotation (Line(points={{50,-20},{6,
          -20},{6,-18},{-30,-18},{-30,0}},
                                      color={0,127,255}));
  annotation (Line(
