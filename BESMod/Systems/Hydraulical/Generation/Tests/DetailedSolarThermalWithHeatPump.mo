...
model DetailedSolarThermalWithHeatPump
  "Test for SolarThermalAndHeatPumpDetailed"
...
equation
  connect(pulse.y, genControlBus.yHeaPumSet) annotation (Line(points={{-19,70},{
          -10,70},{-10,74},{10,74}},          color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(const1.y, genControlBus.uEleHea) annotation (Line(points={{39,80},{26,
          80},{26,74},{10,74}},              color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  annotation (experiment(StopTime=3600, Tolerance=1e-06, Interval=100),
     __Dymola_Commands(file="modelica://BESMod/Resources/Scripts/Dymola/Systems/Hydraulical/Generation/Tests/DetailedSolarThermalWithHeatPump.mos"
          "Simulate and plot"),
    Documentation(info="<html>
<p>
  Test for  
  <a href=\"modelica://BESMod.Systems.Hydraulical.Generation.DetailedSolarThermalWithHeatPump\">BESMod.Systems.Hydraulical.Generation.DetailedSolarThermalWithHeatPump</a>.
</p>
<p>
