...
record SubsystemControlBaseDataDefinition
  ...
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal[nParallelDem]
    ...
    parameter Modelica.SIunits.Temperature TOda_nominal "Nominal outdoor air temperature" annotation(Dialog(group="System Design"));

  parameter Modelica.SIunits.Temperature TDem_nominal[nParallelDem] "Nominal demand temperature"  annotation (Dialog(group="System Design"));
  parameter Modelica.SIunits.Temperature TSup_nominal[nParallelSup] "Nominal supply temperature"  annotation (Dialog(group="System Design"));
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal[nParallelDem]
