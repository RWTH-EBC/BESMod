...
model PartParallelBivalent "Part-parallel bivalent control"
  ...
  Modelica.Blocks.Logical.GreaterEqualThreshold greEquTCutOff(threshold=TCutOff)
    "Check if greater than cut off temperature"
...
equation
  ...
  connect(greEquTCutOff.y, and1.u1) annotation (Line(points={{37.2,66},{42,66},{
          42,56},{58,56}}, color={255,0,255}));
  connect(hysSto.y, and1.u2) annotation (Line(points={{-16,38},{42,38},{42,48},{
          58,48}}, color={255,0,255}));
  connect(and1.y, priGenOn) annotation (Line(points={{81,56},{92,56},{92,60},{110,
          60}}, color={255,0,255}));
  connect(TOda, greEquTCutOff.u)
