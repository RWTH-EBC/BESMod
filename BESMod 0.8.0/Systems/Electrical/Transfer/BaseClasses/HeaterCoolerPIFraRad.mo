...
model HeaterCoolerPIFraRad
  "heater and cooler with variable setpoints with fraction for rad"
  extends BESMod.Systems.Electrical.Transfer.BaseClasses.PartialHeaterCoolerPI;
